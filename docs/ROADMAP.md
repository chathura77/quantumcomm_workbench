...
- The BB84 interactive demo and guided lab tables now include explicit captions and summary linkage so screen-reader users can follow the row-level teaching trace without relying on surrounding prose alone.
